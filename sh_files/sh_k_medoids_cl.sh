...
python modular_code/main_kmedoids_cl.py \
        --data /home/mmalu/CL_HAR/code/ESC_cls_incremental \
        --epochs_per_task 100 \
...
# Dist thresholds - wav2vec2 - 0.07 # clusters - 5
# Dist thresholds - clap - 0.34 # clusters - 5
# Dist thresholds - whisper - 0.07 # clusters - 5
